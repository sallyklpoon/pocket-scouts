 ...
 * Use the {@link NavBarActivity#newInstance} factory method to
...
public class NavBarActivity extends Fragment {
    ...
    public static NavBarActivity newInstance(String param1, String param2) {
        NavBarActivity fragment = new NavBarActivity();
